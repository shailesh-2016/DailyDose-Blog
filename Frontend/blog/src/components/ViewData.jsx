...
const BlogCard = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 text-gray-800 dark:text-white p-4 rounded shadow">
      <div className="p-6 bg-gray-100 dark:bg-gray-800 min-h-screen">
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {Blog.map((item) => (
                <div
                  key={item._id}
                  className="bg-white dark:bg-gray-700 rounded-2xl shadow-md p-6 hover:shadow-xl transition-all duration-300 w-[320px] h-[450px] flex flex-col"
                >
                  {item.blog_image && (
        ...
        {selectedBlog && (
          ...
          >
            <div
              className="bg-white dark:bg-gray-800 text-gray-800 dark:text-white rounded-lg max-w-lg p-6 relative"
